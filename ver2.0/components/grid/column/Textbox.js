 ...
 * @constructor
 */
ColumnTextBox = function (config) {
  CT.apply(this, config || {});//apply configuration
  ColumnTextBox.superclass.constructor.call(this);
};
CT.extend(ColumnTextBox, GridEditor, {
  render: function (v) {
...
ColumnManager.registerType('text', ColumnTextBox);