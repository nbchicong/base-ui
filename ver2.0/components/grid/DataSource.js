  ...
  DataSource.prototype = {
    ...
    setData: function (datas) {
      ...
      _.filter(datas, function (item) {
        if(isEmpty(item[me.getIdProperty()])) {
          item[me.getIdProperty()] = CT.generateId().toString();
        }
    ...
    insert: function (item) {
      var __item =item || {};
      if(isEmpty(__item[this.getIdProperty()])) {
        __item[this.getIdProperty()] = CT.generateId().toString();
      }
    ...
    data: function (options, callback) {
      var self = this;
      var isRemote = !isEmpty(options.count);
